      ...
      return (
          <div className="js">
            <div className="js-container1">
              <h2>JavaScript</h2>
              <p>JavaScript is NOT Java! Instead, a good definition of JavaScript or JS is: "JavaScript allows you to make web pages more interactive by assessing and modifying
                the content and markup used in a web page while it is being viewed in the browser." JavaScript works with different object types, including strings, numbers, dates, and arrays.
